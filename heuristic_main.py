...
if __name__ == '__main__':
    ...
    np.save(f"result/region_shape_{region_shape}_mu_3", mu_3)
    np.save(f"result/region_shape_{region_shape}_the_3", the_3)
    np.save(f"result/region_shape_{region_shape}_Psi_3", Psi_3)
    end_3 = timer()
